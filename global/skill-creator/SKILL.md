...
description: >
  ...
  Use when users want to create a new skill, update or optimize an existing skill,
  run evals to test a skill, or benchmark skill performance.
tags: [skills, meta, creation, development, testing]
globs: ["skills/**", ".claude/skills/**", ".cursor/rules/**", "catalog.json", "skills.lock.json"]
